...
NestJS REST API that fetches music artists from iTunes API and filters them based on the current day of the week. Built as a technical assessment demonstrating enterprise-grade architecture, dependency injection, and API integration.
